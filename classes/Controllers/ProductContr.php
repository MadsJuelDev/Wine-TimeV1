...
class ProductContr extends Product
{
    ...
    public function __construct($pType, $pName, $pPrice, $pDiscount, $pStock, $pBoxsale, $pDescription, $pImgUrl)
    {
    ...
    public function createProduct()
    {
        ...
        $this->setProduct($this->pType, $this->pName, $this->pPrice, $this->pDiscount, $this->pStock, $this->pBoxsale, $this->pDescription, $this->pImgUrl);
    }
