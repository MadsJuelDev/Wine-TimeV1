...
<section class="section">
    <div class="container">
        <h2 class="section__title">Transactions for : <?php echo $userEmail ?></h2>
        <style type="text/css">
            .tg {
                border: none;
            ...
            <table class="tg">
                <thead>
                    <tr>
                        ...
                        <th class="tg-0lax" style="border-bottom: 2px solid white !important;">View</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    $transactionView = new \DAO\Transactions();
                    $transactionView->getUserTransactions($userEmail);
                    ?>
                </tbody>
            </table>
        </div>
